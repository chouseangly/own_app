                ...
                <form @submit.prevent="changePassword">
                    ...
                    <div class="form-row">
                        <div class="form-col-12 sm:form-col-6">
                            ...
                            <input v-model="form.new_password" v-bind:class="errors.new_password ? 'invalid' : ''"
                                id="old_password" type="password" class="db-field-control">
                    ...
                    <div class="form-row">
                        <div class="form-col-12 sm:form-col-6">
                            ...
                            <input v-model="form.confirm_password"
                                v-bind:class="errors.comfirm_password ? 'invalid' : ''" id="old_password"
                                type="password" class="db-field-control">
                            <small class="db-field-alert" v-if="errors.firm_password">
                                {{ errors.firm_password[0] }}
                            </small>
                        </div>
                    </div>
    ...
    methods:{
        changePassword:function(){
            try{
                ...
                this.$store.dispatch("frontendEditProfile/chagnePassword",this.form).then((res)=>{
